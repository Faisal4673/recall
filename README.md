Hey - Not sure if anyone will ever read this. This is a simple ai agent/chatbot. It uses the deepseek api, so the format will work with any deepseek model. Set your api key as an env. variable.
...
Try and contribute if you are interested but I might not read the PRs.
